...
import com.weatherapp.current_weather.presentation.di.CurrentWeatherComponent
import com.weatherapp.current_weather.presentation.di.CurrentWeatherDepsProvider
import com.weatherapp.current_weather.presentation.di.DaggerCurrentWeatherComponent
...
class CurrentWeatherApplication : Application(), LoginDepsProvider, SplashDepsProvider,
    ResourceProvider,
    CurrentWeatherDepsProvider,
    WorldWeatherDepsProvider {
