package com.weatherapp.current_weather.presentation.di
...
class CurrentLocationNetworkModule {
    ...
    fun provideUserRepository(
        ...
        return com.weatherapp.current_weather.data.network.WeatherRepositoryImpl(
...
class LastDataModule {
    ...
    @Provides
    @Singleton
    fun provideLastDataRepository(storage: LastDataStorage): LastDataRepository {
        return LastDataRepositoryImplSharedPrefs(
            storage
        )
    }
    ...
    @Provides
    @Singleton
    fun provideGetLastDataUseCase(repository: LastDataRepository): GetLastDataUseCase {
        return GetLastDataUseCase(repository)
    }

    @Provides
    @Singleton
    fun provideSaveLastDataUseCase(repository: LastDataRepository): SaveLastDataUseCase {
